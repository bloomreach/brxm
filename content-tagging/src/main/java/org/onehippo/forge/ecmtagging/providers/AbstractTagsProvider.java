...
/**
 * All tag providers should extend this base class. It registers the provider so that the suggester can find it and it
 * provides an interface with a convenience method.
 */
