...
<form name="theForm">
  ...
  <p>
    Product : 
    <a href='<hst:link path="/products/${document.product}/" mount="restservices" />' target='_blank'
       title='Click the left link to see all products of the same product type in XML generated by a Plain JAX-RS Service.'>${document.product}</a>
  </p>
  <p>
