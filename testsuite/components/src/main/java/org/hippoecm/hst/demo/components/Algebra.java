...
public class Algebra extends BaseHstComponent {
    ...
    public static final String LINEAR_ALGEBRA_MODULE_NAME_SUB = "org.hippoecm.hst.demo.addonmodules.linearalgebra.sub";
    ...
    public void doBeforeRender(final HstRequest request, final HstResponse response) throws HstComponentException {
        ...
        InverseOperator inverseOperatorDelegatee = HstServices.getComponentManager().getComponent("inverseOperatorDelegatee", LINEAR_ALGEBRA_MODULE_NAME_SUB);
