...
package org.onehippo.forge.selectiondemo.components;
...
public class Multilingual extends BaseHstComponent {

    public static final Logger log = LoggerFactory.getLogger(Multilingual.class);
