...
import static org.onehippo.cms.translations.RepositoryResourceBundleLoader.collectResourceBundles;
...
public class RepositoryResourceBundle extends ResourceBundle {
    ...
    @Override
    public String getId() {
        return getFileName() + "/" + getName() + "/" + getLocale();
    }
    ...
    static Iterable<ResourceBundle> createAllInstances(final String fileName, final File file) throws IOException {
        ...
        try (FileInputStream in = new FileInputStream(file)) {
            ...
            collectResourceBundles(jsonObject, fileName, Collections.singletonList("en"), new RepositoryResourceBundleLoader.Path(), bundles);
        }
