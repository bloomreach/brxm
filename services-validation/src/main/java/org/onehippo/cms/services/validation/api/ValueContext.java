...
public interface ValueContext {
    ...
    /**
     * @return the JCR name of the value (e.g. "myproject:startDate").
     */
    String getJcrName();

    /**
     * @return the JCR type of the value (e.g. "Date")
     */
    String getJcrType();

    /**
     * @return the type of the value. Can be the same as {@link #getJcrType} (e.g. for "String"),
