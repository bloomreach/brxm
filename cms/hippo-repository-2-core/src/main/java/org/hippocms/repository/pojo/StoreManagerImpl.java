...
public class StoreManagerImpl extends StoreManager
{
  ...
  public void updateObject(StateManager sm, int fieldNumbers[]) { updateObject(sm, fieldNumbers); }
  ...
  public Object getStrategyValue(ObjectManager om, DatastoreClass table, AbstractClassMetaData cmd, int absoluteFieldNumber) {
    return new JCROID();
  }
