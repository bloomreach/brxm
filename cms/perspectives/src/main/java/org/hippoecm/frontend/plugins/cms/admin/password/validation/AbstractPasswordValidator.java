...
public abstract class AbstractPasswordValidator implements IPasswordValidator {
    ...
    public AbstractPasswordValidator(final boolean optional) {
        this.optional = optional;
    }

    public AbstractPasswordValidator(final IPluginConfig config) {
    ...
    public PasswordValidationStatus checkPassword(final String password, final User user) throws RepositoryException {
        final PasswordValidationStatus result;
