//
// REMOVE ME: This file is used to read (by ChartsCreator) and write (by HistoryWriter) the xml
// historypoint files.
//
// Although cute this falls under GPL and doesn't make much sense in this context anyway, use jibx instead.
//
