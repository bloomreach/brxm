...
public class MenuTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException {
        ...
        try {
            ...
            Menu menu = Menu.getMenu(request.getSession(), getId(), location);
    ...
    private void doOutputDefault(Menu menu, PageContext pageContext) throws IOException, JspException {
        ...
        writeDefaultOutput(buffer, menu.getItems(), menu.getId(), 0/*currentLevel*/, pageContext);
    ...
    private void doOutputByInclude(Menu menu, PageContext pageContext, String viewFile) 
        ...
        // set menu under id in the request for easy access 
    ...
    private void writeDefaultOutput(StringBuffer buffer, List<MenuItem> menuItems,
                    String menuId, int currentLevel, PageContext pageContext) {
        ...
        if (getLevel() <= currentLevel) {
            ...
            boolean doWriteId = getLevel() == currentLevel;
            ...
            if (iterator.hasNext()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    // recursion!
                    writeDefaultOutput(buffer, item.getItems(), menuId, item.getLevel() + 1, pageContext);
            ...
            while (iterator.hasNext()) {
                ...
                if (item.isActive()) {
                    ...
                    // recursion!
                    writeDefaultOutput(buffer, item.getItems(), null/*id*/, item.getLevel() + 1, pageContext);
