...
public class ImagePickerBehavior extends DialogBehavior<RichTextEditorImageLink> {
    ...
    @Override
    protected Dialog<RichTextEditorImageLink> createDialog(final IPluginContext context, final IPluginConfig config) {
