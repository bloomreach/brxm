...
public abstract class CKEditorImage extends DocumentLink {
    private static final long serialVersionUID = 1L;


    static final Logger log = LoggerFactory.getLogger(CKEditorImage.class);
    ...
    public CKEditorImage(Map<String, String> values, IDetachable targetId) {
