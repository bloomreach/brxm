...
package org.hippoecm.frontend.plugins.ckeditor.dialog;
...
public abstract class AbstractCKEditorDialog<T extends IPersisted> extends AbstractDialog<T> {
    private static final long serialVersionUID = 1L;


    private boolean hasExistingLink;

    public AbstractCKEditorDialog(IModel<T> model) {
        super(model);
    ...
    public final void onClose() {
        ...
        final String script = cancelled ? getCancelScript() : getCloseScript();
