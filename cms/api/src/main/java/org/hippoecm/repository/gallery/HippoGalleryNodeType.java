...
public class HippoGalleryNodeType {
    ...
    public static final String IMAGE_HEIGHT = "hippogallery:height";

    public static final String IMAGE_SET = "hippogallery:imageset";
    public static final String IMAGE_SET_FILE_NAME = "hippogallery:filename";
