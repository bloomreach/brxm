...
public class InterpolationUtils {
     ...
     * It uses the variable prefix <code>"${"</code>.
     * it uses the variable suffix <code>"}"</code>.
     * The escape sequence {@code //} can be used before a variable reference to ignore the expression.
