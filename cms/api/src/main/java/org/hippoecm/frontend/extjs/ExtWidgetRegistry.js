...
(function () {
  ...
  Hippo.ExtWidgetRegistry = Ext.extend(Ext.util.Observable, {
     ...
     *
     * @param config either an object with the initial configuration of the widget, or a String with the xtype of the
     *   widget. A configuration object must contain the property 'xtype' with the xtype of the widget. Providing an
     *   String parameter 'somestring' is a shorthand for providing a configuration object { xtype: 'somestring' }.
