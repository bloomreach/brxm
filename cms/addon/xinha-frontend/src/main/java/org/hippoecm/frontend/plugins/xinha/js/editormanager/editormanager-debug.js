            ...
            resize : function(deltaW, deltaH) {
                ...
                if(this.isFullScreen()) {
                    ...
                    if(Xinha._currentlyActiveEditor === this.xinha ) {
                        var el = this.xinha._iframe;
                        while(!Dom.hasClass(el, 'hippo-editor-field-html')) {
                        ...
                        this.xinha.suspendUpdateToolbar = true;
                        */
                    }
                    this.setSize(newWidth, newHeight);
                    if(lastRange != null) {
                        var el = this.xinha._iframe;
                        var fixCaretBugPartTwo = function() {
                            Dom.setStyle(el, 'zIndex', 0);
                        }
                        Dom.setStyle(el, 'zIndex', -1);
                        ...
                        /*
                        this.xinha.suspendUpdateToolbar = false;
