...
public class PreviewImage extends WebComponent {
    ...
    public PreviewImage(String id, IModel model, String width, String height) {
        super(id, model);
        this.width = width;
        this.height = height;
    }

    public PreviewImage(String id, String url, String width, String height) {
        this(id, new Model(url), width, height);
    }
