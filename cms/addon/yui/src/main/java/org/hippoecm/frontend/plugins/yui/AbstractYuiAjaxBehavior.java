 ...
 * them inside an element's onclick attribute, this behavior uses an {@link AjaxSettings} instance in which it will
 * store the callbackUrl, a list of allowed callbackParameters and an anonymous function that takes the callbackUrl as 
 * an argument and executes the callbackScript that is generated by the {@link AbstractDefaultAjaxBehavior}.  
 * </p>
 * 
 * <p>
