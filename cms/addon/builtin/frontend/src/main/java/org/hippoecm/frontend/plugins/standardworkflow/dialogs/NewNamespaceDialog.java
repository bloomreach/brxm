...
import org.hippoecm.frontend.plugins.standardworkflow.NewNamespaceWorkflowPlugin;
import org.hippoecm.frontend.widgets.TextFieldWidget;
import org.hippoecm.repository.standardworkflow.RemodelWorkflow;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class NewNamespaceDialog extends AbstractWorkflowDialog {
    ...
    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(NewNamespaceDialog.class);

    private String prefix;

    private String url;

    public NewNamespaceDialog(NewNamespaceWorkflowPlugin plugin, IDialogService dialogWindow) {
