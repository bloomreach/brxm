...
public class NewCopyModelDialog extends AbstractWorkflowDialog {
    @SuppressWarnings("unused")
    private final static String SVN_ID = "$Id$";

    private static final long serialVersionUID = 1L;

    private static final Logger log = LoggerFactory.getLogger(NewCopyModelDialog.class);

    private String name;

    public NewCopyModelDialog(EditmodelWorkflowPlugin plugin, IDialogService dialogWindow) {
