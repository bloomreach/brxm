...
public class NewOrderableFolderWorkflowPlugin extends NewFolderWorkflowPlugin {
    @SuppressWarnings("unused")
    private final static String SVN_ID = "$Id$";
    private static final long serialVersionUID = 1L;

    private final static Logger log = LoggerFactory.getLogger(NewOrderableFolderWorkflowPlugin.class);

    public NewOrderableFolderWorkflowPlugin(IPluginContext context, IPluginConfig config) {
        ...
        try {
            ...
            DialogAction action = new DialogAction(new IDialogFactory() {
                ...
                public AbstractDialog createDialog(IDialogService dialogService) {
                    return new ReorderDialog(NewOrderableFolderWorkflowPlugin.this, dialogService, jcrRef);
                }
            }, getDialogService());
