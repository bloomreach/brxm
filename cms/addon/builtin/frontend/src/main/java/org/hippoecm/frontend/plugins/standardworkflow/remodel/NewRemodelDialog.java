...
import org.hippoecm.frontend.plugins.standardworkflow.NewRemodelWorkflowPlugin;
...
public class NewRemodelDialog extends AbstractWorkflowDialog {
    @SuppressWarnings("unused")
    private final static String SVN_ID = "$Id$";
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(NewRemodelDialog.class);

    private IServiceReference<IJcrService> jcrServiceRef;

    public NewRemodelDialog(NewRemodelWorkflowPlugin plugin, IDialogService dialogWindow,
