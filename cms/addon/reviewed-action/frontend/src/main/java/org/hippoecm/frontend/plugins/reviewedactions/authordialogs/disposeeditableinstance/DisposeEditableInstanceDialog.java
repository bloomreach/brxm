 ...
 */
package org.hippoecm.frontend.plugins.reviewedactions.authordialogs.disposeeditableinstance;
...
public class DisposeEditableInstanceDialog extends AbstractWorkflowDialog {
    ...
    public DisposeEditableInstanceDialog(final DialogWindow dialogWindow, JcrNodeModel model, AuthorReviewedActionsWorkflow workflow) {
