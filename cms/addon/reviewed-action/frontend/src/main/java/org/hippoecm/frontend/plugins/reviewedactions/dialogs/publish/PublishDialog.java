 ...
 */
package org.hippoecm.frontend.plugins.reviewedactions.dialogs.publish;
...
public class PublishDialog extends AbstractWorkflowDialog {
    ...
    public PublishDialog(final DialogWindow dialogWindow, JcrNodeModel model, ReviewedActionsWorkflow workflow) {
