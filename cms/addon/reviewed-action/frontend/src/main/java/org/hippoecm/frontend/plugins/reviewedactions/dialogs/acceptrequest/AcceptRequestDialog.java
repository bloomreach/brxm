 ...
 */
package org.hippoecm.frontend.plugins.reviewedactions.dialogs.acceptrequest;
...
public class AcceptRequestDialog extends AbstractWorkflowDialog {
    ...
    public AcceptRequestDialog(final DialogWindow dialogWindow, JcrNodeModel model, RequestWorkflow workflow) {
