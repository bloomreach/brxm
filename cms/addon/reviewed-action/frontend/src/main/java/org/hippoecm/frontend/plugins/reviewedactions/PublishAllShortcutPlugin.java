...
public class PublishAllShortcutPlugin extends RenderPlugin {
    ...
    static Logger log = LoggerFactory.getLogger(PublishAllShortcutPlugin.class);

    final static String QUERY_LANGUAGE_PUBLISH = Query.SQL;
    final static String QUERY_STATEMENT_PUBLISH = "SELECT * FROM hippostd:publishable WHERE jcr:path LIKE '/content/%' AND hippostd:state='unpublished'";
    final static String QUERY_LANGUAGE_DEPUBLISH = Query.SQL;
    final static String QUERY_STATEMENT_DEPUBLISH = "SELECT * FROM hippostd:publishable WHERE jcr:path LIKE '/content/%' AND hippostd:state='published'";
