...
public class JcrSearchTranslatePlugin extends AbstractTranslateService implements IPlugin {
    private static final long serialVersionUID = 1L;

    final static Logger log = LoggerFactory.getLogger(JcrSearchTranslatePlugin.class);

    public JcrSearchTranslatePlugin(IPluginContext context, IPluginConfig config) {
    ...
    public IModel getModel(Map<String, String> criteria) {
        try {
            ...
            String strQuery = "//element(" + ISO9075Helper.encodeLocalName(criteria.get("hippo:key"))
                    + ", hippo:translation)[@hippo:language='"
