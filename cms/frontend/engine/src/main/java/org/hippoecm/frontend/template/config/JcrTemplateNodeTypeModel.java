...
public class JcrTemplateNodeTypeModel extends NodeModelWrapper {
    private static final long serialVersionUID = 1L;

    private static final Logger log = LoggerFactory.getLogger(JcrTemplateNodeTypeModel.class);

    private String typeName;

    public JcrTemplateNodeTypeModel(JcrNodeModel model, String type) {
        super(model);
        typeName = type;
    }
    ...
    public UUID addField(String type) {
        try {
