...
public class NamespaceDialog extends Dialog<Node> {
    ...
    public NamespaceDialog() {
        setTitle(Model.of("Add namespace"));
        setSize(DialogConstants.SMALL);

        add(setFocus(new RequiredTextFieldWidget("prefix", new PropertyModel<>(this, "prefix"), Model.of("namespace prefix"))));
        add(new RequiredTextFieldWidget("uri", new PropertyModel<>(this, "uri"), Model.of("namespace uri")));
    }
