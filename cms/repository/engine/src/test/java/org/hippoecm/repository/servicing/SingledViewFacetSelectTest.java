...
public class SingledViewFacetSelectTest  extends TestCase {
    ...
    private static String[] contents = new String[] {
        ...
        "/documents/articles/foo/brave-new-world/brave-new-world",          "hippo:document",
        "language","english",
        "state","published",
        "/documents/articles/foo/brave-new-world/brave-new-world",          "hippo:document",
        "language","dutch",
        "/documents/articles/foo/brave-new-world2",                          "hippo:handle",
        "/documents/articles/foo/brave-new-world2/brave-new-world2",          "hippo:document",
        "language","english",
        "state","published",
        "/documents/articles/foo/brave-new-world2/brave-new-world2",          "hippo:document",
        "language","dutch",
        ...
        "language","english",
        "/documents/articles/war-of-the-worlds/war-of-the-worlds/handle-below-document/handle-below-document", "hippo:document",
        "language","english",
        "/documents/articles/war-of-the-worlds/war-of-the-worlds/handle-below-document/handle-below-document", "hippo:document",
        "language","dutch",
