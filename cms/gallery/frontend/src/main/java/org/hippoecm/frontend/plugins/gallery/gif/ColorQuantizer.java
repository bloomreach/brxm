...
%  Reduction, and AssignmenLicensed under the ImageMagick License (the "License"); you may not use
   this file except in compliance with the License.t.  Classification builds a color description
