...
public final class FullTextSearchParser {
    ...
    public static String fullTextParseHstMode(final String input, final boolean allowSingleNonLeadingWildCardPerTerm) {
        ...
        parsed = foldToASCIIReplacer(parsed);
    ...
    public static String foldToASCIIReplacer(String input) {
        if(input == null) {
            return null;
        }
        ...
        final int maxSizeNeeded = 4 * inputChars.length;
        char[] output = new char[maxSizeNeeded];
        //char[] output = new char[ArrayUtil.oversize(maxSizeNeeded, RamUsageEstimator.NUM_BYTES_CHAR)];
        //int outputPos = ASCIIFoldingFilter.foldToASCII(inputChars, 0, output, 0, inputChars.length);
    ...
    /**
     * @deprecated deprecated since 2.25.00. Use {@link #foldToASCIIReplacer(String)} instead
     */
    @Deprecated
