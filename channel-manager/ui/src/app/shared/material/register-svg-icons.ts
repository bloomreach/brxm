...
import checkCircleOutline from '!!raw-loader!./icons/check-circle-outline.svg';
...
import infoOutline from '!!raw-loader!./icons/info-outline.svg';
...
import removeCircleOutline from '!!raw-loader!./icons/remove-circle-outline.svg';
...
export function registerSvgIcons(iconRegistry: MatIconRegistry, domSanitizer: DomSanitizer): void {
  ...
  registerIcon('check-circle-outline', checkCircleOutline);
  ...
  registerIcon('info-outline', infoOutline);
  ...
  registerIcon('remove-circle-outline', removeCircleOutline);
