        ...
        _loadVariants: function() {
            if (!this.isMultivariate()) {
                return Hippo.Future.constant([
                    {id: 'hippo-default', name: Hippo.ChannelManager.ChannelEditor.Resources['component-variants-default']}
                ]);
            } else {
                var self = this;
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(result) {
                                ...
                                self._loadComponentVariants(variantIds).when(function(variants) {
                                    variants.push({id: 'plus', name: Hippo.ChannelManager.ChannelEditor.Resources['component-variants-plus']});
                                    success(variants);
