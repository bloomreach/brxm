...
(function() {
    ...
    Hippo.ChannelManager.ChannelStore = Ext.extend(Ext.data.GroupingStore, {
        constructor: function(config) {
            // Explicitly set the data type for automatic conversion from received data to the stored value.
            // The 'string' type will be use case insensitive 'asUCString' sorting, see Ext.data.SortTypes.
