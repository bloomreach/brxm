...
public class TemplateComposerResourceBehavior extends AbstractBehavior {
    ...
    public void bind(Component component) {
        if (Application.get().getDebugSettings().isAjaxDebugModeEnabled()) {
            ...
            component.add(JavascriptPackageResource.getHeaderContribution(PageEditorBundle.class, PageEditorBundle.MANAGE_CHANGES_WINDOW));
            ...
            component.add(JavascriptPackageResource.getHeaderContribution(PageEditorBundle.class, PageEditorBundle.MESSAGE_BUS));
