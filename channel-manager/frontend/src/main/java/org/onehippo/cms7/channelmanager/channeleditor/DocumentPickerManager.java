 ...
 */
public class DocumentPickerManager extends LinkPickerManager<RichTextEditorDocumentLink> {

    public DocumentPickerManager(final IPluginContext context, final String channelEditorId) {
