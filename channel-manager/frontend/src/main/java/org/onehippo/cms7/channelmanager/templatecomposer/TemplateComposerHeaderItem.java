...
public class TemplateComposerHeaderItem extends HeaderItem {
    ...
    static {
        ...
        developmentRefs.addAll(javaScriptResources(ChannelEditorBundle.class, ChannelEditorBundle.FILES));
        ...
        deploymentRefs.addAll(javaScriptResources(ChannelEditorBundle.class, ChannelEditorBundle.ALL));
