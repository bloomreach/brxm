...
const contentEditorModule = angular
  .module('hippo-cm.channel.contentEditor', [
    fieldsModule,
  ])
  .component('contentEditor', contentEditorComponent)
  .service('ContentEditor', contentEditorService);

export default contentEditorModule.name;
