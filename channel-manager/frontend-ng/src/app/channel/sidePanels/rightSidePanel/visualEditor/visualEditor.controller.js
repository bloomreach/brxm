...
class visualEditorController {
  ...
  $onInit() {
    ...
    TODO: Deal with save
    TODO: Deal with document ditr
     */
    this.onClose({ promiseCallback: () => this.close() });
    this.onSave({ promiseCallback: this.saveDocument });
  }
  ...
  isSaveDisabled() {
    return !this.isDocumentDirty() || this.form.$invalid;
  }
...
export default visualEditorController;
