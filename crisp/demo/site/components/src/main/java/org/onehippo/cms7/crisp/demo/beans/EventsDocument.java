...
@HippoEssentialsGenerated(internalName = "crispdemo:eventsdocument")
@Node(jcrType="crispdemo:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public static final String DOCUMENT_TYPE = "crispdemo:eventsdocument";
    ...
    private static final String END_DATE = "crispdemo:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "crispdemo:enddate")
