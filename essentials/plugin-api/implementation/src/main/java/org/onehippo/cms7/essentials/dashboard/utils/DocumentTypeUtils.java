...
public final class DocumentTypeUtils {
    ...
    /**
     * Register document type for given base type and namespace. If document already exists, we'll just return existing node
     *
     ...
     * @return node namespace node or null if failed.
     */
    public static Node registerDocumentType(final String documentName, final String baseType, final String namespace, final PluginContext context) {
