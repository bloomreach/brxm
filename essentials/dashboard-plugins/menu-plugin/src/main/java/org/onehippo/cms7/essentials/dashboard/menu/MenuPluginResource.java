...
@Path("/menu")
public class MenuPluginResource extends BaseResource {


    /**
     * Executes Menu powerpack
     */
    @POST
    @Path("/")
    public MessageRestful executePowerpack(@Context ServletContext servletContext) {
        final MessageRestful message = new MessageRestful();
        final PluginContext context = getContext(servletContext);
        final PowerpackPackage powerpack = new MenuPowerpack();
