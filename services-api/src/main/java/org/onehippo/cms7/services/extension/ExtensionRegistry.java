...
public class ExtensionRegistry {
     ...
     */
    public synchronized static void register(final ServletContext ctx, final ExtensionType type) {
        ...
        newMap.put(ctx.getContextPath(), Thread.currentThread().getContextClassLoader());
