...
@FieldGroupList({
        @FieldGroup(value = {"hideFutureItems", "documentDateField", "path", "includeSubtypes", "documentTypes"},
                titleKey = "list.group")
})
public interface EssentialsNewsComponentInfo extends EssentialsListComponentInfo {
    /**
     ...
     */
    @Parameter(name = "hideFutureItems", defaultValue = "true")
