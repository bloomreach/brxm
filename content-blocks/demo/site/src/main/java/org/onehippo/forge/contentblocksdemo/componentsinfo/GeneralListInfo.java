 ...
 */
package org.onehippo.forge.contentblocksdemo.componentsinfo;
...
public interface GeneralListInfo  {
    ...
    @Parameter(name = "docType", displayName = "Document Type", defaultValue="contentblocksdemo:basedocument")
    String getDocType();
