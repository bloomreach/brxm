...
public class M8 {
    ...
    static void initialize() {
        ...
        try {
            ...
            mappings.add(new NamespaceMapping("hippogallery",   "http://www.hippoecm.org/hippogallery/nt/",   "hippogallery.cnd",   clazz.getClassLoader().getResourceAsStream("hippogallery.cnd")));
        ...
        for(String namespace : addedPrefixes) {
            ...
            CND namespaceCND = new CND(workspace, namespaceSet) {
                ...
                protected String getPrefixNamespaceURI(String prefix) throws RepositoryException {
                    ...
                    if(M8.prefixes.contains(prefix)) {
