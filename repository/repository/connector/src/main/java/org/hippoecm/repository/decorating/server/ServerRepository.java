...
public class ServerRepository extends org.apache.jackrabbit.rmi.server.ServerRepository implements RemoteRepository {
    ...
    public RemoteRepositoryService getRepositoryService() throws RepositoryException, RemoteException {
        ...
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippostd/nt/2.1", "folder"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippostd/nt/2.1", "gallery"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippostd/nt/2.1", "directory"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippostd/nt/2.1", "fixeddirectory"), 3);
        ...
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippo/nt/2.1", "document"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippogallery/nt/2.1", "exampleImageSet"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippogallery/nt/2.1", "exampleAssetSet"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippogallery/nt/2.1", "stdgalleryset"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippogallery/nt/2.1", "stdImageGallery"), 3);
        cfg.setDepth(NameFactoryImpl.getInstance().create("http://www.onehippo.org/jcr/hippogallery/nt/2.1", "stdAssetGallery"), 3);
