...
public class VersionDecorator extends NodeDecorator implements Version {
    ...
    protected VersionDecorator(DecoratorFactory factory, SessionDecorator session, Version version) {
        super(factory, session, (HippoNode)version);
    ...
    public static Version unwrap(Version version) throws RepositoryException {
        ...
        if (version instanceof VersionDecorator) {
            ((VersionDecorator)version).check();
