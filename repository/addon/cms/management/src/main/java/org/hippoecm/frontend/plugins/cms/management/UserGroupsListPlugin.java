...
public class UserGroupsListPlugin extends QueryListPlugin {
    ...
    public static HippoNode addMultiValueProperty(HippoNode node, String propertyName, String propertyValue) throws ValueFormatException, VersionException, LockException, ConstraintViolationException, PathNotFoundException, IllegalStateException, RepositoryException {
