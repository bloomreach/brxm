...
class LinkPickerDialogInfoPanel extends Panel {
    @SuppressWarnings("unused")
    private final static String SVN_ID = "$Id: LinkPickerDialogInfoPanel.java 12039 2008-06-13 09:27:05Z bvanhalderen $";
    ...
    LinkPickerDialogInfoPanel(String id, JcrPropertyValueModel model) {
        super(id, model);
