...
public class CopyTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        Node handle, node, root = session.getRootNode();
        ...
        node.addNode("destination", "hippostd:folder").addMixin("hippo:harddocument");
        node = node.addNode("folder", "hippostd:folder");
        node.addMixin("hippo:harddocument");
        handle = node.addNode("document", "hippo:handle");
    ...
    private void testPublishableDocument(boolean duplicate, boolean unpublished, boolean published, boolean secondDocument) throws WorkflowException, MappingException, RepositoryException, RemoteException {
