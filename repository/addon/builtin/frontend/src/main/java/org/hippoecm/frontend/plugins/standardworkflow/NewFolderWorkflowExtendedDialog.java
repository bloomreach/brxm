...
public class NewFolderWorkflowExtendedDialog extends AbstractWorkflowDialog {
    ...
    public NewFolderWorkflowExtendedDialog(NewAbstractFolderWorkflowPlugin folderWorkflowPlugin, IDialogService dialogWindow, String category) {
