...
public class NewCreateTypeDialog extends AbstractWorkflowDialog {
    ...
    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(NewCreateTypeDialog.class);

    private String name;

    private IServiceReference<IJcrService> jcrServiceRef;

    public NewCreateTypeDialog(AbstractWorkflowPlugin plugin, IDialogService dialogService,
