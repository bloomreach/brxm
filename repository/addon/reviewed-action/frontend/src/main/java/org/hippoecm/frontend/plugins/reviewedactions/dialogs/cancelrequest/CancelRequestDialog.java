 ...
 */
package org.hippoecm.frontend.plugins.reviewedactions.dialogs.cancelrequest;
...
public class CancelRequestDialog extends AbstractWorkflowDialog {
    ...
    public CancelRequestDialog(final DialogWindow dialogWindow, JcrNodeModel model, RequestWorkflow workflow) {
