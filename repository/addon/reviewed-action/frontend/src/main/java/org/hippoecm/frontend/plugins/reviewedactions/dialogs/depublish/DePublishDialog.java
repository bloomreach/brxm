 ...
 */
package org.hippoecm.frontend.plugins.reviewedactions.dialogs.depublish;
...
public class DePublishDialog extends AbstractWorkflowDialog {
    ...
    public DePublishDialog(final DialogWindow dialogWindow, JcrNodeModel model, ReviewedActionsWorkflow workflow) {
