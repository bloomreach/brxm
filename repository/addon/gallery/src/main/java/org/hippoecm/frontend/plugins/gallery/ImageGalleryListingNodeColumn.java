...
public class ImageGalleryListingNodeColumn extends NodeColumn {
    ...
    public ImageGalleryListingNodeColumn(IModel displayModel, String nodePropertyName, ImageGalleryPlugin plugin) {
    ...
    protected NodeCell getNodeCell(String componentId, IModel model, String nodePropertyName) {
        return new ImageGalleryListingNodeCell(componentId, (JcrNodeModel) model, nodePropertyName, plugin);
    }
