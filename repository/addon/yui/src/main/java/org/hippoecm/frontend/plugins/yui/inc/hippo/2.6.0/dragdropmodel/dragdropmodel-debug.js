...
( function() {
	...
	YAHOO.extend(YAHOO.hippo.DDBaseDragModel, YAHOO.util.DDProxy, {
	    ...
	    TYPE: "DDBaseDragModel",
	     ...
	     initPlayer: function(id, sGroup, config) {
	        ...
	        YAHOO.log(id + " startpos: " + this.startPos, "info", "DDBaseDragModel");
	    },
	    ...
	    startDrag: function(x, y) {
	        ...
	        YAHOO.log(this.id + " startDrag", "info", "DDBaseDragModel");
	        
	        this.setStartStyle();
	
	        var targets = YAHOO.util.DDM.getRelated(this, true);
	        YAHOO.log(targets.length + " targets", "info", "DDBaseDragModel");
	        ...
	        for (var i=0; i<targets.length; i++) {
	            ...
	            YAHOO.log("Old style = " + this.originalStyles[targetEl.id], "info", "DDBaseDragModel");
	...
	YAHOO.extend(YAHOO.hippo.DDModel, YAHOO.hippo.DDBaseDragModel, {
	    ...
	    setStartStyle: function() {
	        YAHOO.log(this.id + " setStartStyle", "info", "DDModel");
	...
	YAHOO.extend(YAHOO.hippo.DDRemove, YAHOO.hippo.DDBaseDragModel, {
	    ...
	    TYPE: "DDRemove",
	     ...
	     initPlayer: function(id, sGroup, config) {
	        ...
	        this.startPos = YAHOO.util.Dom.getXY( this.getEl() );
	        YAHOO.log(id + " startpos: " + this.startPos, "info", "DDRemove");
