...
public class DocumentWorkflowTest extends BaseDocumentWorkflowTest {
    ...
    public void testVariants() throws Exception {
        ...
        assertMatchingSCXMLStates(wf.getWorkflowExecutor(), StatesBuilder.build()
                ...
                .branchable().canCheckoutBranch().canRemoveBranch().canReintegrateBranch()
                .states()
        );
        ...
        assertMatchingSCXMLStates(wf.getWorkflowExecutor(), StatesBuilder.build()
                ...
                .noBranchable().noCheckoutBranch().noRemoveBranch().noReintegrateBranch()
                .states()
        );
    ...
    public void testPublishState() throws Exception {
        ...
        assertMatchingSCXMLStates(wf.getWorkflowExecutor(), StatesBuilder.build()
                ...
                .noBranchable().noCheckoutBranch().noRemoveBranch().canReintegrateBranch()
                .states()
        );
