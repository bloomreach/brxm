...
import org.onehippo.repository.scxml.reviewedactions.ReviewedActionsEvents;
...
public class CurrentFullWorkflowParallelModelTransitionTest extends AbstractCurrentFullWorkflowModelTest {
    ...
    public void testCreateDocument() throws Exception {
        ...
        SCXMLUtils.triggerSignalEvents(executor, ReviewedActionsEvents.WFE_DOC_EDIT_OBTAIN);
    ...
    public void testCommitAndCloseDraft() throws Exception {
        ...
        SCXMLUtils.triggerSignalEvents(executor, ReviewedActionsEvents.WFE_DOC_EDIT_COMMIT);
        SCXMLUtils.triggerSignalEvents(executor, ReviewedActionsEvents.WFE_DOC_EDIT_DISPOSE);
    ...
    public void testPublish() throws Exception {
        ...
        SCXMLUtils.triggerSignalEvents(executor, ReviewedActionsEvents.WFE_DOC_PUBLISH);
    ...
    public void testDepublish() throws Exception {
        ...
        SCXMLUtils.triggerSignalEvents(executor, ReviewedActionsEvents.WFE_DOC_DEPUBLISH);
    ...
    public void testRemoveDocument() throws Exception {
        ...
        SCXMLUtils.triggerSignalEvents(executor, ReviewedActionsEvents.WFE_DOC_DELETE);
