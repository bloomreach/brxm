 ...
 */
@Deprecated
public class JCRFullRequestWorkflowImpl extends JCRBasicRequestWorkflowImpl implements FullRequestWorkflow {

    private static final Logger log = LoggerFactory.getLogger(JCRFullRequestWorkflowImpl.class);
    ...
    public JCRFullRequestWorkflowImpl() throws RemoteException {
    }
