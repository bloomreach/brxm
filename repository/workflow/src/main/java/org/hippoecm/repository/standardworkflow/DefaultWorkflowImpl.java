...
public class DefaultWorkflowImpl implements DefaultWorkflow, EditableWorkflow, InternalWorkflow {
    ...
    public Document saveDraft() throws WorkflowException {
        throw new WorkflowException("Document type does not allow for keeping draft changes");
    }

    @Override
    public Document editDraft() throws WorkflowException {
        throw new WorkflowException("Document type does not allow for editing draft changes");
    }
