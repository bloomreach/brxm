...
/**
 * <p>
 *     A wrapper class for a {@link Session} which when used as an object in an {@link javax.servlet.http.HttpSession}
 *     attribute will make sure that the wrapped {@link Session} will be logged out when the {@link javax.servlet.http.HttpSession}
 ...
 *     from {@link #getOrCreateJcrSession(String, HttpSession, SimpleCredentials, Repository)},
 *     then on next invocation of {@link #getOrCreateJcrSession(String, HttpSession, SimpleCredentials, Repository)} a
...
public class HttpSessionBoundJcrSessionHolder implements HttpSessionActivationListener, HttpSessionBindingListener {
     ...
     * @param repository the {@link Repository} to login against
     * @return
