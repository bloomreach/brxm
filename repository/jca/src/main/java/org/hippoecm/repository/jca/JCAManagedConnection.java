...
public final class JCAManagedConnection implements ManagedConnection, ManagedConnectionMetaData {
     ...
     */
    public JCAManagedConnection(JCAManagedConnectionFactory mcf, JCAConnectionRequestInfo cri, HippoSession session) {
        this.mcf = mcf;
        this.cri = cri;
     ...
     * Return the session.
     */
    public HippoSession getSession(JCASessionHandle handle) {
        synchronized (handles) {
