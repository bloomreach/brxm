...
public class WorkflowEventLoggerWorkflowImpl implements WorkflowEventLoggerWorkflow, InternalWorkflow {
    ...
    public void logWorkflowStep(String userName, String className, String methodName, Object[] args, Object returnObject, String documentPath) {
        logWorkflowStep(userName, className, methodName, args, returnObject, documentPath, null);
    }

    @Override
    public void logWorkflowStep(final String userName, final String className, final String methodName, final Object[] args, final Object returnObject, final String documentPath, final String interactionId) {
        ...
        postEvent(userName, className, methodName, documentPath, handleUuid, returnType, returnValue, arguments, interactionId);
    }
    ...
    private void postEvent(String who, String className, String methodName, String documentPath, String handleUuid, String returnType, String returnValue, String[] arguments, String interactionId) {
