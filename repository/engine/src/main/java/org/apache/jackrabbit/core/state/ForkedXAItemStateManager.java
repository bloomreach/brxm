...
public class ForkedXAItemStateManager extends LocalItemStateManager implements InternalXAResource {
     ...
     */
    public ForkedXAItemStateManager(SharedItemStateManager sharedStateMgr,
     ...
     */
    public static ForkedXAItemStateManager createInstance(SharedItemStateManager sharedStateMgr,
            EventStateCollectionFactory factory, String attributeName, ItemStateCacheFactory cacheFactory) {
        ForkedXAItemStateManager mgr = new ForkedXAItemStateManager(sharedStateMgr, factory, attributeName, cacheFactory);
