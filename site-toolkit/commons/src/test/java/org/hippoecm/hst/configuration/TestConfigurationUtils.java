...
public class TestConfigurationUtils {
    ...
    @Test
    public void testSupportedSchemeNotMatchingResponseCodes() {
        for (int expectedSchemeNotMatchingResponseCode : expectedSchemeNotMatchingResponseCodes) {
            assertTrue(isSupportedSchemeNotMatchingResponseCode(expectedSchemeNotMatchingResponseCode));
        }
        assertFalse(isSupportedSchemeNotMatchingResponseCode(199));
    }


    @Test
    public void testSupportedSchemeNotMatchingResponseCodesAsString() {
        assertEquals("200, 301, 302, 303, 307, 403, 404", supportedSchemeNotMatchingResponseCodesAsString());
    }
}
