...
public class TestMockComponentConfiguration {
    
    @Test
    public void testSimpleProperties() throws Exception {
        MockComponentConfiguration bean = new MockComponentConfiguration();
        ...
        MockBeanTestHelper.verifyReadWriteProperty(bean, "canonicalPath", "test-canonicalPath");
