...
public class TestResponseWithDynamicBeans extends PageModelAPITest {

    private static final Logger log = LoggerFactory.getLogger(TestResponseWithDynamicBeans.class);
