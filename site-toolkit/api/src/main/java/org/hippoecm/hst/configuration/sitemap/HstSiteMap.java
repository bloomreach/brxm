...
public interface HstSiteMap {
     ...
     * Implementations should return an unmodifiable list, for example the one returned by
     * {@link Collections#unmodifiableList(List)} to avoid client code changing configuration
