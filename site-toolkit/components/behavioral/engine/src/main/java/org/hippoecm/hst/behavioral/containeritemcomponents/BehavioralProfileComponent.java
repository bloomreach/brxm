...
public class BehavioralProfileComponent extends BaseHstComponent {

    public static final Logger log = LoggerFactory.getLogger(BehavioralProfileComponent.class);
