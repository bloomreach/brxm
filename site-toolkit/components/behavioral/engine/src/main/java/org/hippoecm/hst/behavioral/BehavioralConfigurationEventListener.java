...
public class BehavioralConfigurationEventListener extends GenericEventListener implements EventListenersContainerListener {
    
    static Logger log = LoggerFactory.getLogger(BehavioralConfigurationEventListener.class);
    
    private BehavioralService behavioralService;
    
    public void setBehavioralService(BehavioralService behavioralService) {
