 ...
 * ESIElementFragment
 * <P>
 * ESI element tag fragment such as include or remove.
 * </P>
 */
public class ESIElementFragment extends ESIFragment {
    ...
    public ESIElementFragment(ESIFragmentType type, String source) {
        super(type, source);
    }
    ...
    public void setElement(SerializableElement element) {
