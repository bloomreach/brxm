...
/**
 * The provider implementation for URL providers ({@link HstContainerURLProvider}).
 * 
 * @version $Id$
 */
public class HstContainerURLProviderProviderImpl implements HstContainerURLProviderProvider {
