...
public class TestGenericResponseHeadersValve {
    ...
    public void testCacheResponseHeaders() throws Exception {
        ...
        Set<String> headerNames = servletResponse.getHeaderNames();
        ...
        assertEquals(Long.toString(expireDate.getTime()), servletResponse.getHeader("Expires").toString());
        
        List<Object> authorHeaders = servletResponse.getHeaders("Author");
