 ...
 * @version $Id$
 */
@Path("/hippofacnav:facetsavailablenavigation/")
public class HippoFacetsAvailableNavigationContentResource extends HippoFacetNavigationContentResource {
    
    private static Logger log = LoggerFactory.getLogger(HippoFacetsAvailableNavigationContentResource.class);
