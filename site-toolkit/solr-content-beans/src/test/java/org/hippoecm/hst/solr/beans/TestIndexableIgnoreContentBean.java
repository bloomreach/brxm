...
public class TestIndexableIgnoreContentBean implements IdentifiableContentBean {

    private String identifier;

    public TestIndexableIgnoreContentBean() {

    }

    public TestIndexableIgnoreContentBean(String identifier) {
