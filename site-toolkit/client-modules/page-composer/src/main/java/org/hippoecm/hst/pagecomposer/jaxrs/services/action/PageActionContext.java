...
public class PageActionContext {
    ...
    PageActionContext setHomePage(boolean value) {
        homePage = value;
        return this;
    }

    PageActionContext setLocked(boolean value) {
        locked = value;
        return this;
    }

    PageActionContext setInherited(boolean value) {
        inherited = value;
        return this;
    }

    PageActionContext setWorkspaceConfigured(boolean value) {
