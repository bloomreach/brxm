...
import org.hippoecm.hst.pagecomposer.jaxrs.services.state.util.DocumentState;
import org.hippoecm.hst.pagecomposer.jaxrs.services.state.util.DocumentStateUtils;
...
public class XPageStateContextFactory {

    public XPageStateContext make(final PageComposerContextService contextService) throws RepositoryException {
