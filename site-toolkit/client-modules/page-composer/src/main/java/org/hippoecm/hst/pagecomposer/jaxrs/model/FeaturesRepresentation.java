...
public class FeaturesRepresentation {
    ...
    private boolean channelDeletionSupported;
    ...
    public boolean isChannelDeletionSupported() {
        return channelDeletionSupported;
    }

    public void setChannelDeletionSupported(final boolean channelDeletionSupported) {
        this.channelDeletionSupported = channelDeletionSupported;
    }
}
