...
public class PageCreateContextImpl extends AbstractPageContext implements PageCreateContext {

    private transient Node newSiteMapItemNode;
    private transient Node newPageNode;

    public PageCreateContextImpl(final HstRequestContext requestContext,
