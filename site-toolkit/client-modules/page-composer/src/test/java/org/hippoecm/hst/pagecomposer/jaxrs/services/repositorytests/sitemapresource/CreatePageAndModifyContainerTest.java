 ...
 */
public class CreatePageAndModifyContainerTest extends AbstractSiteMapResourceTest {
    ...
    public void test_create_page_and_modify_container() throws Exception {
        ...
        final long versionStamp = container.getProperty(HstNodeTypes.GENERAL_PROPERTY_LAST_MODIFIED).getDate().getTimeInMillis();
        ...
        assertTrue("Container should be explicitly locked.",
    ...
    @Test
    public void test_create_page_and_modify_container_fails_incorrect_versionStamp() throws Exception {
        // add catalog item first
        Node catalogItem = addDefaultCatalogItem();
        initContext();
        final SiteMapItemRepresentation newFoo = createSiteMapItemRepresentation("foo", getPrototypePageUUID());
