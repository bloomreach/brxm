...
public class ChannelsResourceConsts {
	...
	public static final String MESSAGE_CHANNEL_PERSISTING_ERROR = "Error while persisting a new channel - Channel: %s - %s : %s : %s";
	...
	public static final String WARNING_MESSAGE_FAILED_TO_RETRIEVE_CHANNEL_RESOURCE_VALUES = "Failed to retrieve channel resource values channel with id '%s'";
	...
	public static final String PARAM_MESSAGE_FAILED_TO_RETRIEVE_CHANNEL_RESOURCE_VALUES = "Failed to retrieve channel resource values for channel with id '{}' - {}";
