...
public class CmsRestMountAndVirtualHostAugmenter implements HstConfigurationAugmenter {
        ...
        try {
           ...
           if (cmsHost == null) {
               ...
               if (portMount == null) {
                   ...
                   if (rootMount == null) {
                      MutableMount cmsRestRootMount = new CmsRestMount(cmsHost);
    ...
    private class CmsRestPortMount implements MutablePortMount {
        ...
        private CmsRestPortMount(VirtualHost virtualHost) throws ServiceException {
            rootMount = new CmsRestMount(virtualHost);
        }
    ...
    private class CmsRestMount implements MutableMount {
        ...
        private CmsRestMount(VirtualHost virtualHost) throws ServiceException {
        ...
        public String getNamedPipeline() {
            if(namedPipeline == null) {
                throw new IllegalStateException("Cannot invoke pipeline when namedPipeline = null for " + this.getClass().getName());
            } 
