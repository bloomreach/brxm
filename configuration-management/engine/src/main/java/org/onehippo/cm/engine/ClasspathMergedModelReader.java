...
public class ClasspathMergedModelReader {
    ...
    public MergedModel read(final ClassLoader classLoader, final boolean explicitSequencing, final boolean verifyOnly)
        ...
        while (resources.hasMoreElements()) {
            ...
            try (FileSystem fs = FileSystems.newFileSystem(jarPath, null)) {
                ...
                final FileConfigurationReader.ReadResult result =
                        new FileConfigurationReader(explicitSequencing).read(repoConfig, verifyOnly);
