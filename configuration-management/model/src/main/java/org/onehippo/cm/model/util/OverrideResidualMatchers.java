 ...
 */
public class OverrideResidualMatchers {

    private final List<Matcher> matchers;

    public OverrideResidualMatchers(final String... patterns) throws IllegalArgumentException {
     ...
     */
    public ConfigurationItemCategory getMatch(final String path) {
