...
#
# BE CAREFUL:
# - A released package can be un-released with "npm unpublish @bloomreach/spa-sdk@<version>"
...
echo
echo "Published version ${version}, see https://www.npmjs.com/package/@bloomreach/spa-sdk?activeTab=versions"
echo
